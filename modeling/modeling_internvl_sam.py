...
class InternVLSAMModel (PreTrainedModel ):
    ...
    img_context_token_id :Optional [int ]=None ,
        ...
        vit_embeds ,image_embeddings =self .extract_feature (pixel_values )
        ...
        if outputs .hidden_states is not None :
            ...
            image_token_indices =torch .nonzero (image_token_mask ,as_tuple =True )[0 ]
    ...
    def extract_feature (self ,pixel_values ):
        ...
        features =vit_features .permute (0 ,2 ,3 ,1 )
        features =self .pixel_shuffle (features ,scale_factor =self .downsample_ratio )
